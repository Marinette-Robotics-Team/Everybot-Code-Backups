...
public class Robot extends TimedRobot {
  ...
  CANSparkMax driveLeftSparkOne = new CANSparkMax(1, MotorType.kBrushless);
  CANSparkMax driveLeftSparkTwo = new CANSparkMax(2, MotorType.kBrushless);
  MotorControllerGroup driveLeftSide = new MotorControllerGroup(
    driveLeftSparkOne,
    driveLeftSparkTwo
  );

  CANSparkMax driveRightSparkThree = new CANSparkMax(3, MotorType.kBrushless);
  CANSparkMax driveRightSparkFour = new CANSparkMax(4, MotorType.kBrushless);

  MotorControllerGroup driveRightSide = new MotorControllerGroup(
    driveRightSparkThree,
    driveRightSparkFour
  );
  ...
  public void robotInit() {
     ...
     */
    driveLeftSparkOne.setInverted(false);
    driveLeftSparkOne.setOpenLoopRampRate(1);

    driveLeftSparkTwo.setInverted(false);
    driveLeftSparkTwo.setOpenLoopRampRate(1);

    driveRightSparkThree.setInverted(true);
    driveRightSparkThree.setOpenLoopRampRate(1);

    driveRightSparkFour.setInverted(true);
    driveRightSparkFour.setOpenLoopRampRate(1);
  ...
  public void setDriveMotors(double forward, double turn) {
    ...
    // directions.
    driveLeftSide.set(left);
    driveRightSide.set(right);
  }
  ...
  public void autonomousInit() {
    // driveLeftSparkOne.setIdleMode(IdleMode.kBrake);
    // driveLeftSparkTwo.setIdleMode(IdleMode.kBrake);
    // driveRightSparkThree.setIdleMode(IdleMode.kBrake);
    // driveRightSparkFour.setIdleMode(IdleMode.kBrake);
  ...
  public void teleopPeriodic() {
     ...
     */
    double magicTurn = 0;
    if (j.getRawAxis(2) > 0.05) {
      magicTurn = j.getRawAxis(2);
    } else if (j.getRawAxis(3) > 0.05) {
      magicTurn = -j.getRawAxis(3);
    } else {
      magicTurn = 0;
    }

    setDriveMotors(-j.getRawAxis(1), magicTurn);
  }
}
